...
<body class="text-center" background="images/coding.jpeg">
        <form class ="form-signin" action="proses_loginp.php" method="post" id="myForm" onsubmit="return validasi(this)">
        <img class="mb-4" src="icons/itworkicon.png" alt="" width="72" height="72">
    <h1 class="h3 mb-3 font-weight-normal">Company<br />Please sign in</h1>
            <div class="mb-3 row">
            ...
            <label>
			<a href="login.php">Log In As Worker</a> <br/>
            <a href="registrasi_perusahaan.php">Don't Have an Account? Register</a>
            </label>
            </div>
